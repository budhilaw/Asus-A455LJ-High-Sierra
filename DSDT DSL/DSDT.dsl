 ...
 *
 * Disassembly of DSDT.aml, Mon Dec  4 17:09:08 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00017B71 (97137)
 *     Revision         0x02
 *     Checksum         0x0D
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    External (CRBI, IntObj)    // Warning: Unknown object
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xC5771000, 0x0359)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
                ...
                Device (IGPU)
                {
                    ...
                    Method (_DSM, 4, NotSerialized)
                    {
                        ...
                        Return (Package (0x08)
                        {
                            ...
                            Buffer (0x17)
                            {
                                "Intel HD Graphics 5500 Ganteng Edition"
                            }, 
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0xC4A55F18, 0x10)
...
Else
{
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        ...
        Method (OSSW, 0, Serialized)
        {
            Store (RRAM (0x0E84), Local0)
        ...
        Method (PHST, 0, NotSerialized)
        {
            Store (RRAM (0x0E81), Local0)
            And (Local0, 0x80, Local0)
            If (Local0)
            {
                Return (0x00010001)
        ...
        Method (DKST, 0, NotSerialized)
        {
            Store (RRAM (0x0E80), Local0)
            And (Local0, 0x80, Local0)
            If (Local0)
            {
                Return (0x00010001)
    ...
    Scope (\)
    {
        ...
        {
            /* 0000 */  0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xFF, 0x00, 0xFF,
            /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00             
        })
        Name (VISB, Buffer (0x0E)
        {
            /* 0000 */  0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x01,
            /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00             
        })
            ...
            Name (BUF0, ResourceTemplate()
{
    ...
    OperationRegion (ABNV, SystemMemory, 0xC5760000, 0x000D)
